...
iris = pd.read_csv('CorkStoppers.data', header=None, sep=' ')
iris1 = iris.iloc[0:150, 0:10]
traffic_target=iris.iloc[0:150,10]
print(iris1)
iris2 = np.mat(iris1)
X1 = iris2[0:50, 0:10]
X2 = iris2[50:100, 0:10]
X3 = iris2[100:150, 0:10]
...
# 遗传算法
def GA(d):
    population = np.zeros((n, 10))  # 初始化种群
