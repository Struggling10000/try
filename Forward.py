...
class HMM:
    ...
    def __init__(self):
        self.A = array([(0, 1, 0, 0), (0.4, 0, 0.6, 0), (0, 0.4, 0, 0.6), (0, 0, 0.5, 0.5)])  # 转移概率矩阵
        self.B = array([(0.5, 0.5), (0.3, 0.7), (0.6, 0.4), (0.8, 0.2)])  # 观测概率
        self.pi = array([(0.25), (0.25), (0.25), (0.25)])  # 初始概率
        # X = {Red，Red，White，White，Red} red = 0， white = 1
        self.o = [0, 0, 1, 1, 0]  # 观测序列
        self.t = len(self.o)
        self.m = len(self.A)  # 状态集合个数#观测序列长度
