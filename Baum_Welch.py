...
if __name__ == '__main__':
    ...
    pi = [0.5, 0.5]
    A = [[19 / 20, 1 / 20], [1 / 20, 19 / 20]]
    B = [[1 / 6, 1 / 6, 1 / 6, 1 / 6, 1 / 6, 1 / 6], [1 / 10, 1 / 10, 1 / 10, 1 / 10, 1 / 10, 1 / 2]]
    O = [
        [0, 1, 3, 4, 4, 1, 5, 3, 5, 1, 0, 3, 5, 0, 3, 5, 0, 2, 5, 0, 2, 5, 5, 5, 0, 5, 5, 3, 5, 5, 0, 5, 2, 5, 5, 0, 5,
         2, 5, 5, 0, 5, 2, 5, 0, 5, 4, 0, 4, 5, 0, 4, 0, 0, 4, 0, 3, 5, 0, 1, 2, 4, 5, 1, 2, 3, 3]
    ]
    L = len(O)
